...
<template>
    <div class="grid_wrapper fade">
        <h1 class="info"><a href="https://discord.gg/C5EGU9k8">Discord</a>  <router-link to="/contribute">Help contribute to missing screenshots</router-link>  <router-link to="/dmca" style="float:right">DMCA</router-link></h1>
        <div class="grid">
